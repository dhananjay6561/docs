...
<img src="https://keploy-devrel.s3.us-west-2.amazonaws.com/docs/webp-s3/img/result-openhospital.webp" alt="Sample Keploy Test Summary Java" width="100%" style={{ borderRadius: '5px' }} />
