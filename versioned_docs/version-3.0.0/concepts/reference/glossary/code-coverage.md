...
<video autoPlay loop muted playsInline width="800" height="450" style={{maxWidth:'100%',height:'auto'}} aria-label="Keploy test replay"><source src="https://keploy.io/docs/gif/replay-tc.mp4" type="video/mp4" /></video>
