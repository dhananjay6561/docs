...
<div style={{backgroundColor:'white', padding:'10px', display:'inline-block', borderRadius:'8px'}}>
  <video autoPlay loop muted playsInline width="562" height="356" style={{maxWidth:'100%',height:'auto'}} aria-label="Test Case Generator"><source src="/docs/gif/how-keploy-works.mp4" type="video/mp4" /></video>
</div>
